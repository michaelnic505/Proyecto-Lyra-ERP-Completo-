 ...
 * 
 */
public class LastAccountByParentRetrieveHandler implements RequestHandler<LastAccountByParentRetrieveRequest>{

    @Override
    public Object handle(LastAccountByParentRetrieveRequest request) {
        return AccountingAccountService.getLastAccountNumberByParentId(request);
    }
