 ...
 * 
 */
public class LastAccountBySubclassRetrieveHandler implements RequestHandler<LastAccountBySubclassRetrieveRequest>{

    @Override
    public Object handle(LastAccountBySubclassRetrieveRequest request) {
        return AccountingAccountService.getLastAccountBySubclassId(request);
    }
