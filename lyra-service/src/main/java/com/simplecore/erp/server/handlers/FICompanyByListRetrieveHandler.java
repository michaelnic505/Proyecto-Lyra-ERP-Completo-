 ...
 * 
 */
public class FICompanyByListRetrieveHandler implements RequestHandler<FICompanyByListRetrieveRequest>{

    @Override
    public Object handle(FICompanyByListRetrieveRequest request) {
        return FICompanyService.getFICompanyByList(request);
    }
