...
public class AuxiliarWindow extends javax.swing.JDialog {
    ...
    public AuxiliarWindow(Frame parent, JButton button,String[] columnNames, Object[][]dataMatrix,
    ...
    private void returnSelectedRow() {
        ...
        if (selectedRow != -1 && rowSelectionListener != null) {
            ...
            for (int i = 0; i < selectedColumns.size(); i++) {
                selectedData[i] = tableList.getModel().getValueAt(selectedRow, selectedColumns.get(i));
            }
