...
import com.simplecore.erp.client.gui.workspace.modules.financial.financialaccounting.chartofaccount.config.InitChangeChartOfAccountRegistrar;
 ...
 * 
 */
public class InitModifyChartOfAccountController extends AbstractInitFormController<InitModifyChartOfAccounts> {
    ...
    public InitModifyChartOfAccountController(InitModifyChartOfAccounts panel,
            OperationType operationType,
            ObjectOutputStream output,
            ObjectInputStream input,
            ActiveSession session) {
        super(panel, operationType, output,input,session,
                () -> new InitChangeChartOfAccountRegistrar(panel, output, input, session));
    }
