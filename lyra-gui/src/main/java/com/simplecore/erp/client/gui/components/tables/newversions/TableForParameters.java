...
import com.simplecore.erp.client.gui.components.tables.interfaces.ButtonForTableParameters;
import com.simplecore.erp.client.gui.components.tables.interfaces.TableButtonListener;
import com.simplecore.erp.client.gui.components.tables.interfaces.TableForParametersModel;

public class TableForParameters extends JTable {
    ...
    public TableForParameters() {
        ...
        getColumnModel().getSelectionModel().addListSelectionListener((ListSelectionEvent e1) -> {
            if (e1.getFirstIndex() == 0) {
    ...
    void setModel(){
        TableForParametersModel modelo = new TableForParametersModel();
        modelo.setColumnIdentifiers(new String[]{"Col1","Col2","Col3","Col4"});
            ...
            if (isSelected) {
                if (column == 1) {
                    if (!table.isCellEditable(row, column)) {
                        comp.setBackground(getColorSeleccionColumnasNoEditables());
                ...
                if (!table.isCellEditable(row, column)) {
                    comp.setBackground(getColumnNoEditableColor());
                } else {
                    comp.setBackground(getColorColumnas());
                }
            }
    ...
    public void addTableButtonListener(TableButtonListener e){
        this.e = e;
        this.getColumnModel().getColumn(0).setCellEditor(new CellEditor());
    }
