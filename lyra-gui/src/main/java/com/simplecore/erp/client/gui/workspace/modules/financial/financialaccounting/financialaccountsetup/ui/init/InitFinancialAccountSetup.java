package com.simplecore.erp.client.gui.workspace.modules.financial.financialaccounting.financialaccountsetup.ui.init;
...
import com.simplecore.erp.client.gui.workspace.modules.financial.financialaccounting.financialaccountsetup.controllers.InitFinancialAccountSetupController;
...
public class InitFinancialAccountSetup extends AbstractInitPanel{
    
    public InitFinancialAccountSetup() {
        super(OperationType.CONFIG);
        initComponents();
    }
    ...
    protected void initGeneralController(OperationType operationType,
        ...
        var controller = new InitFinancialAccountSetupController(this, operationType, output, input, session);
    ...
    private void initComponents() {
        ...
        moduleTitleLabel.setText("Financial Account Setup");
