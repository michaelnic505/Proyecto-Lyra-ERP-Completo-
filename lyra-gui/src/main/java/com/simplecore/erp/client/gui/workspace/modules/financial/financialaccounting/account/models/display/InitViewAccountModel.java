...
public class InitViewAccountModel extends JPanel implements TransactionPanel, RowSelectionListener{
    ...
    private AccountModelRetrieveResponse getAcountModelByName(String modelName) {
        try {
            ...
            Logger.getLogger(InitViewAccountModel.class.getName()).log(Level.SEVERE, null, ex);
        }
        return null;
    }
    ...
    public void onRowSelected(Object[] selectedData) {
        ...
        accountModelDescription = (String) selectedData[2];

        accountModelMatchCode.getTextField().setText(accountModelName);
        accountModelDescriptionLabel.setText(accountModelDescription);
    }

    List<Integer> columnsToReturn = List.of(0, 1, 2);
    ...
    private void goToTaskPanel() {
        ...
        ViewAccountModel changeModel = new ViewAccountModel(accountModelID, accountModelName,
    ...
    private void initComponents() {
        ...
        moduleTitleLabel.setText("View Account Model");
