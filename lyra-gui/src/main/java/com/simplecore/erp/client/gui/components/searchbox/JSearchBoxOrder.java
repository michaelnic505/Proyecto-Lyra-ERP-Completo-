...
public class JSearchBoxOrder extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        fondoNegro = new com.simplecore.erp.client.gui.components.searchbox.PanelNegroButtonRedondeado();
        button = new com.simplecore.erp.client.gui.components.labels.JButtonHQ();
    ...
    private com.simplecore.erp.client.gui.components.labels.JButtonHQ button;
    private com.simplecore.erp.client.gui.components.searchbox.PanelNegroButtonRedondeado fondoNegro;
