package com.simplecore.erp.client.gui.notifications;

import java.awt.Color;
import javax.swing.*;
import com.simplecore.erp.client.gui.components.labels.JLabelHQBackground;
...
public class SystemMessages {
    ...
    public SystemMessages(String message, TypeMessage type) {
        this(Workspace.NotificationLabel, message, type);
    }
    public SystemMessages(){
        this.label = Workspace.NotificationLabel;
    }
