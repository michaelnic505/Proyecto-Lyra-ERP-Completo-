...
public class InitChangeAccountingAccount extends JPanel implements TransactionPanel,TaskPanel, RowSelectionListener{
    ...
    public InitChangeAccountingAccount() {
        initComponents();
        initEvents();
    ...
    private void gotoNextPanel() {
        ...
        ChangeAccountingAccount changeAccount = new ChangeAccountingAccount(modelId, classId, accountingAccount);
        changeAccount.initialize(transactionCode,activeSession, output, input);
        PanelManager.goToPanel(changeAccount);
