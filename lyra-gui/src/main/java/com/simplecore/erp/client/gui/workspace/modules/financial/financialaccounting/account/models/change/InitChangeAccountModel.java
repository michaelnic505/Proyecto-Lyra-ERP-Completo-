...
public class InitChangeAccountModel extends JPanel implements TransactionPanel, RowSelectionListener{
    ...
    private AccountModelRetrieveResponse getAcountModelByName(String modelName) {
        try {
            ...
            Logger.getLogger(InitChangeAccountModel.class.getName()).log(Level.SEVERE, null, ex);
        }
        return null;
    }
    ...
    private void goToTaskPanel() {
        ...
        ChangeAccountModel changeModel = new ChangeAccountModel(accountModelID, accountModelName,
