...
import com.simplecore.erp.client.gui.workspace.modules.financial.financialaccounting.company.controller.InitViewFICompanyController;
...
public class InitViewFICompany extends AbstractInitPanel {

    public InitViewFICompany() {
    ...
    protected void initGeneralController(OperationType operationType, ObjectOutputStream output, ObjectInputStream input, 
        ...
        var controller = new InitViewFICompanyController(this, operationType, output, input, session);
    ...
    private void initComponents() {
        ...
        moduleTitleLabel.setText("FI Company - View");
