...
public class ListWindow extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jPanel_CornerPainted1 = new com.simplecore.erp.client.gui.components.panels.JPanelCornerPainted();
        jPanel_Rounded_Corners_Degradado1 = new com.simplecore.erp.client.gui.components.panels.JPanelRoundedGradient();
        exitButton = new com.simplecore.erp.client.gui.components.labels.JButtonHQ();
        selectButton = new com.simplecore.erp.client.gui.components.labels.JButtonHQ();
        menuPanel = new com.simplecore.erp.client.gui.components.panels.JPanelRoundedGradient();
        windowTitleLabel = new com.simplecore.erp.client.gui.components.labels.JLabelHQ();
        disposeButton = new com.simplecore.erp.client.gui.components.labels.JButtonCustom();
        jScrollPane1 = new javax.swing.JScrollPane();
        tableList = new com.simplecore.erp.client.gui.components.tables.newversions.DynamicTable();
    ...
    private com.simplecore.erp.client.gui.components.labels.JButtonCustom disposeButton;
    private com.simplecore.erp.client.gui.components.labels.JButtonHQ exitButton;
    private com.simplecore.erp.client.gui.components.panels.JPanelCornerPainted jPanel_CornerPainted1;
    private com.simplecore.erp.client.gui.components.panels.JPanelRoundedGradient jPanel_Rounded_Corners_Degradado1;
    private javax.swing.JScrollPane jScrollPane1;
    private com.simplecore.erp.client.gui.components.panels.JPanelRoundedGradient menuPanel;
    private com.simplecore.erp.client.gui.components.labels.JButtonHQ selectButton;
    private com.simplecore.erp.client.gui.components.tables.newversions.DynamicTable tableList;
