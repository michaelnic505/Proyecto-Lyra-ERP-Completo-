 ...
 * 
 */
public class FICORelationTypeController extends AbstractComboController<FICORelationTypeService,ComboItem> {

    public FICORelationTypeController(JComboBox<ComboItem> combo, FICORelationTypeService service) {
        super(combo, service);
    }
