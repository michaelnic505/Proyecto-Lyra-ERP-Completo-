...
import com.simplecore.erp.client.gui.workspace.modules.financial.financialaccounting.chartofaccount.controller.InitViewChartOfAccountController;
...
public class InitViewChartOfAccounts extends AbstractInitPanel{
    
    public InitViewChartOfAccounts() {
        super(OperationType.VIEW);
        initComponents();
    }
    ...
    protected void initGeneralController(OperationType operationType, ObjectOutputStream output, ObjectInputStream input, ActiveSession session,String transactionCode) {
        var controller = new InitViewChartOfAccountController(this, OperationType.VIEW, output, input, session);
    ...
    private void initComponents() {
        ...
        moduleTitleLabel.setText("View Chart of Account");
