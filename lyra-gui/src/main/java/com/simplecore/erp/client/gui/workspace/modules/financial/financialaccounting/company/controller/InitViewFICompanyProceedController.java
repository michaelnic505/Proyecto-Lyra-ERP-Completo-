 ...
 * 
 */
public class InitViewFICompanyProceedController extends AbstractProceedButton<
        InitViewFICompany,
        InitViewFICompanyFormState,
        InitViewFICompanyDataHandler> {
    
    private FICompanyRetrieveService companyRetrieveService;

    private InitViewFICompanyProceedController(Builder builder) {
        super(
            builder.panel,
            builder.formState,
            builder.dataHandler,
    ...
    public static class Builder {
        private InitViewFICompany panel;
        ...
        public Builder withPanel(InitViewFICompany panel) {
            this.panel = panel;
            return this;
        }

        public Builder withFormState(InitViewFICompanyFormState formState) {
            this.formState = formState;
            return this;
        }

        public Builder withDataHandler(InitViewFICompanyDataHandler dataHandler) {
        ...
        public InitViewFICompanyProceedController build() {
            return new InitViewFICompanyProceedController(this);
        }
    }
}
