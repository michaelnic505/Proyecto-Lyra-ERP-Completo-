...
import com.simplecore.erp.client.utils.renders.RenderUtil;
...
public class TaxSchemasSearchWindow extends javax.swing.JDialog {
    
    private TableRowSorter<DynamicTableModel> filter;
    private final String[] columnNames;
    private final Object[][] dataMatrix;
    private final TaxSchemaListener rowSelectionListener;
    private final List<Integer> selectedColumns;

    public TaxSchemasSearchWindow(Frame parent, String[] columnNames, Object[][]dataMatrix,
            TaxSchemaListener rowSelectionListener, List<Integer> selectedColumns) {
        super(parent, true);
    ...
    private void setTableModel() {
        ...
        RenderUtil.configureTableRenderers(tableList);
    ...
    private void initComponents() {
        ...
        tableList.setBackground(new java.awt.Color(247, 247, 255));
