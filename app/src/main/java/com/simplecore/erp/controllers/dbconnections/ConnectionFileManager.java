package com.simplecore.erp.controllers.dbconnections;
...
public class ConnectionFileManager {
    private static final String CONNECTION_FILE_URL = "config" + File.separator + "databases" + File.separator + "mysql";
