...
import com.simplecore.erp.models.maintree.TreeNodeData;
import com.simplecore.erp.modules.system.access.exceptions.DatabaseException;
import com.simplecore.erp.modules.system.access.services.BusinessTransactionService;
...
public class TreeMenuController {
    ...
    public TreeMenuController(Connection connection) {
        this.connection = connection;
        this.businessTransactionService = new BusinessTransactionService(connection);
    }

    public void setController(JTree tree, int userId,String username) {
        expandOrCollapseListener(tree);
        doubleClickListener(tree,userId,username);
    }

    private void doubleClickListener(JTree tree, int userId,String username) {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (e.getClickCount() == 2) {
                    ...
                    if (userObject instanceof TreeNodeData nodeData) { // Uso de pattern matching en Java 16+
                        businessTransactionService.openTransaction(nodeData.getCode(), userId,username);
                    }
