 ...
 */
public class DatabaseConnectionFileCreator {

    private static final Logger LOGGER = Logger.getLogger(DatabaseConnectionFileCreator.class.getName());
    ...
    public DatabaseConnectionFileCreator(DatabaseConnection databaseConnection, File directory) {
    ...
    public void createFile() {
        ...
        try (ObjectOutputStream outputStream = new ObjectOutputStream(new FileOutputStream(file))) {
            DatabaseConnectionDataRegistor record = new DatabaseConnectionDataRegistor(databaseConnection);
