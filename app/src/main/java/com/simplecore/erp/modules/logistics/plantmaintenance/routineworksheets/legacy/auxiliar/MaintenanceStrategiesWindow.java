...
public class MaintenanceStrategiesWindow extends javax.swing.JDialog {
    
    private LanguageManager languageManager;
    private JButton button;
    private TableRowSorter<DynamicTableModel> filter;
    
    public MaintenanceStrategiesWindow(Frame parent, JButton button, LanguageManager languageManager) {
        ...
        SwingUtilities.invokeLater(() -> {
            ...
            applyTranslations(languageManager);
...
// Overloaded method for a JTextField and a JLabel
    ...
    private void applyTranslations(LanguageManager lm) {

        tabbedPane.setTitleAt(0, "Search among results");
        String title = LyraWorkspace.getTranslator().getTranslation("MaintenanceStrategiesWindow.title");
    ...
    private String[] getTableColumnsName() {
        ...
        String strategyCode = LyraWorkspace.getTableTranslator().getTranslation("column.strategyCode");
        String strategyDescription = LyraWorkspace.getTableTranslator().getTranslation("column.strategyDescription");
        String strategyUnit = LyraWorkspace.getTableTranslator().getTranslation("column.strategyUnit");
        String apertureHorizon = LyraWorkspace.getTableTranslator().getTranslation("column.apertureHorizon");
        String delayFactorForDelayedConclusion = LyraWorkspace.getTableTranslator().getTranslation("column.delayFactorForDelayedConclusion");
        String toleranceLateCompletion = LyraWorkspace.getTableTranslator().getTranslation("column.toleranceLateCompletion");
        String delayFactorForEarlyConclusion = LyraWorkspace.getTableTranslator().getTranslation("column.delayFactorForEarlyConclusion");
        String toleranceEarlyCompletion = LyraWorkspace.getTableTranslator().getTranslation("column.toleranceEarlyCompletion");
        ...
        return new String[]{
            ...
            strategyUnit,
            apertureHorizon,
            delayFactorForDelayedConclusion,
            toleranceLateCompletion,
            delayFactorForEarlyConclusion,
            toleranceEarlyCompletion
        };
    }
    ...
    private void setTableModel() {
        ...
        MaintenanceStrategies query = new MaintenanceStrategies();
        List<List<Object>> matrix = query.getMaintStrategies(true);
        ...
        tableList.getColumnModel().getColumn(0).setPreferredWidth(100);  // StratCode
        tableList.getColumnModel().getColumn(1).setPreferredWidth(250); // StratDesc
        tableList.getColumnModel().getColumn(2).setPreferredWidth(120); // StratUnit
        tableList.getColumnModel().getColumn(3).setPreferredWidth(120); // ApertureHoriz
        tableList.getColumnModel().getColumn(4).setPreferredWidth(150); // DelayFactorDelayedConclusion
        tableList.getColumnModel().getColumn(5).setPreferredWidth(180); // ToleranceLateCompletion
        tableList.getColumnModel().getColumn(6).setPreferredWidth(150); // DelayFactorEarlyConclusion
        tableList.getColumnModel().getColumn(7).setPreferredWidth(180); // ToleranceEarlyCompletion
