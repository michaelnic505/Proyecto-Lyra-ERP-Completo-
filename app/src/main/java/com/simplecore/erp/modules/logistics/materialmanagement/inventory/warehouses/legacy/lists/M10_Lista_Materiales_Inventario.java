...
public class M10_Lista_Materiales_Inventario extends javax.swing.JPanel {
    
    String VistaSQL;
    private TableRowSorter<DefaultTableModel> filtro;
    
    public M10_Lista_Materiales_Inventario() {
        initComponents(); 
        addEvents();
        cargarTabla();
    }
    ...
    private void cargarTabla() {
        ...
        M10_Cargar_Lista_Inventario nuevaLista = new M10_Cargar_Lista_Inventario();
    ...
    private void initComponents() {
        ...
        menuBar_M10 = new javax.swing.JMenuBar();
        ...
        menuBar_M10.add(MENU_LISTA_MATERIALES);
        ...
        menuBar_M10.add(MENU_DATOS);

        MENU_AYUDA.setText("Ayuda");
        menuBar_M10.add(MENU_AYUDA);
    ...
    public static javax.swing.JMenuBar menuBar_M10;
