...
public class M01_Lista_Clase_Material extends javax.swing.JDialog {        
        
    
    public M01_Lista_Clase_Material(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        cargarModeloTabla();
        cargarDatos();
    ...
    private void cargarModeloTabla(){
        M01_Modelo_Lista_Clases.set(tablaClaseMaterial);
    }   
 

    private void cargarDatos() {
        
        M01_Cargar_Lista_Clase_Material nuevaLista = new M01_Cargar_Lista_Clase_Material();     
    ...
    private void seleccionClaseMaterial(){
        ...
        int fila = tablaClaseMaterial.getSelectedRow();
            if(fila>-1){
              ...
              M01_Creacion_Materiales.ID_CLASE_MATERIAL.setText(ID_CLASE_MATERIAL);
              M01_Creacion_Materiales.DESCRIPCION_CLASE_MATERIAL.setText(DESCRIPCION_CLASE_MAT);
    ...
    private void initComponents() {
        ...
        tablaClaseMaterial.setAutoCreateRowSorter(true);
