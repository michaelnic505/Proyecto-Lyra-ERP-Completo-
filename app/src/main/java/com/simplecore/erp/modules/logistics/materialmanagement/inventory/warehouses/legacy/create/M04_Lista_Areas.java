...
public class M04_Lista_Areas extends javax.swing.JDialog {
        
    
    public M04_Lista_Areas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        cargarModeloTabla();
        cargarDatos();
    ...
    private void cargarModeloTabla(){
        M04_Modelo_Lista_Areas.set(tablaAreaMaterial);
    }   


    private void cargarDatos() {
        
        M04_Cargar_Lista_Area_Almacen nuevaLista = new M04_Cargar_Lista_Area_Almacen();      
    ...
    private void seleccionArea(){
        ...
        int fila = tablaAreaMaterial.getSelectedRow();
            if(fila>-1){
              ...
              M04_Creacion_Almacen.ID_AREA_ALMACEN.setText(ID_TIPO_MATERIAL);
              M04_Creacion_Almacen.DESCRIPCION_AREA_ALMACEN.setText(DESCRIPCION_TIPO_MAT);
    ...
    private void initComponents() {
        ...
        tablaAreaMaterial.setBackground(new java.awt.Color(202, 219, 236));
