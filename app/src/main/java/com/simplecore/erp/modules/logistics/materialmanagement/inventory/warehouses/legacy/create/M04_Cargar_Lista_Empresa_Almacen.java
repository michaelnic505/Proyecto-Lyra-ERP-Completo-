...
public class M04_Cargar_Lista_Empresa_Almacen {
    ...
    public void cargar_Lista_Empresa_Almacen() {
        ...
        try {
            ...
            Logger.getLogger(M04_Cargar_Lista_Empresa_Almacen.class.getName()).log(Level.SEVERE, null, ex);
        }
