...
public class OperationTypesListWindow extends javax.swing.JDialog {
    
    private LanguageManager languageManager;
    private JButton button;
    private TableRowSorter<DynamicTableModel> filter;
     
    public OperationTypesListWindow(Frame parent, JButton button, LanguageManager languageManager) {
...
// Overloaded method for a JTextField and a JLabel
    ...
    private void applyTranslations(LanguageManager lm) {
        ...
        String title = LyraWorkspace.getTranslator().getTranslation("OperationTypesListWindow.title");
