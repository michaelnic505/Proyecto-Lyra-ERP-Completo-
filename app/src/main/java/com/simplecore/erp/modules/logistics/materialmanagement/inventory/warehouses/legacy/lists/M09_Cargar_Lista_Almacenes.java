...
public class M09_Cargar_Lista_Almacenes {
    ...
    public void cargar_Lista_Almacenes() {
        ...
        try {
            ...
            Logger.getLogger(M09_Cargar_Lista_Almacenes.class.getName()).log(Level.SEVERE, null, ex);
        }
