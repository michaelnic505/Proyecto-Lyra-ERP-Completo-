...
public class M01_Lista_Areas extends javax.swing.JDialog {

    
    public M01_Lista_Areas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        cargarModeloTabla();
        cargarDatos();
    ...
    private void cargarModeloTabla(){
        M01_Modelo_Lista_Areas.set(tablaAreaMaterial);
    }   

    private void cargarDatos() {
        
        M01_Cargar_Lista_Area_Material nuevaLista = new M01_Cargar_Lista_Area_Material();      
        nuevaLista.setTABLA_SQL(DatabaseTables.Areas.tableName());
        nuevaLista.setJTABLE(tablaAreaMaterial);
        nuevaLista.cargar_Lista_Area_Material();        
    ...
    private void seleccionAreaMaterial(){
        ...
        int fila = tablaAreaMaterial.getSelectedRow();
            if(fila>-1){
              ...
              M01_Creacion_Materiales.ID_AREA_MATERIAL.setText(ID_TIPO_MATERIAL);
              M01_Creacion_Materiales.DESCRIPCION_AREA_MATERIAL.setText(DESCRIPCION_TIPO_MAT);
    ...
    private void initComponents() {
        ...
        tablaAreaMaterial.setAutoCreateRowSorter(true);
