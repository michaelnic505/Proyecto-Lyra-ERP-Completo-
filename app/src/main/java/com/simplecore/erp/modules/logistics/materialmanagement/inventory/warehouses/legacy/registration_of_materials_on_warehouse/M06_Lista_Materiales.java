...
public class M06_Lista_Materiales extends javax.swing.JPanel {
    
    String VistaSQL;
    private TableRowSorter<DefaultTableModel> filtro;
    
    public M06_Lista_Materiales() {
        initComponents(); 
        addEvents();
        cargarTabla();
    }
    ...
    private void cargarTabla() {
        ...
        M06_Cargar_Lista_Materiales nuevaLista = new M06_Cargar_Lista_Materiales();
    ...
    private void seleccionMaterial() {
        ...
        if (tabla_Materiales.getSelectedRow() > -1) {
            ...
            String ID_UM = tabla_Materiales.getValueAt(tabla_Materiales.getSelectedRow(), 7).toString();
            String DESCRIPCION_UM = tabla_Materiales.getValueAt(tabla_Materiales.getSelectedRow(), 8).toString();        
            String MARCA = tabla_Materiales.getValueAt(tabla_Materiales.getSelectedRow(), 9).toString();        
            String SERIE = tabla_Materiales.getValueAt(tabla_Materiales.getSelectedRow(), 10).toString();        
            String MODELO = tabla_Materiales.getValueAt(tabla_Materiales.getSelectedRow(), 11).toString();        
            
            M06_Alta_Materiales_en_Almacen.CODIGO_MATERIAL.setText(CODIGO_MAT);
            M06_Alta_Materiales_en_Almacen.DESCRIPCION_MATERIAL.setText(DESCRIPCION_MAT);
            M06_Alta_Materiales_en_Almacen.ID_UM.setText(ID_UM);
            M06_Alta_Materiales_en_Almacen.DESCRIPCION_UM.setText(DESCRIPCION_UM);
            M06_Alta_Materiales_en_Almacen.MARCA.setText(MARCA);
            M06_Alta_Materiales_en_Almacen.SERIE.setText(SERIE);
            M06_Alta_Materiales_en_Almacen.MODELO.setText(MODELO);
    ...
    private void initComponents() {
        ...
        LABELTITULO.setText("M06 - Lista de Materiales");
