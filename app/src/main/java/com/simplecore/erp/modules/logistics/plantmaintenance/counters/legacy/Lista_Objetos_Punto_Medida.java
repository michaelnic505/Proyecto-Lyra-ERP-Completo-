...
public class Lista_Objetos_Punto_Medida extends javax.swing.JDialog {

    public Lista_Objetos_Punto_Medida(java.awt.Frame parent) {
    ...
    private void modeloTabla() {
        ...
        String[] columnsES = {"Tp.", "Texto"};
        String[] columnsEN = {"Tp.", "Text"};
        String[] columnsPT = {"Tp.", "Texto"};
    ...
    private void cargarDatos(){
        ...
        model.addRow(new String[]{Objetos_Punto_Medida.IBD.getCode(),Objetos_Punto_Medida.IBD.getDescOPM()});
        model.addRow(new String[]{Objetos_Punto_Medida.IEQ.getCode(),Objetos_Punto_Medida.IEQ.getDescOPM()});
        model.addRow(new String[]{Objetos_Punto_Medida.IFL.getCode(),Objetos_Punto_Medida.IFL.getDescOPM()});
        model.addRow(new String[]{Objetos_Punto_Medida.IME.getCode(),Objetos_Punto_Medida.IME.getDescOPM()});
        
        tableList.setModel(model);
        title.setText(Objetos_Punto_Medida.getTitulo());
