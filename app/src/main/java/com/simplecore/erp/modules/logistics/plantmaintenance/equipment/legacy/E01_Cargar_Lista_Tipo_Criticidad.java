...
public class E01_Cargar_Lista_Tipo_Criticidad {



    public void cargarDatos(JTable table) {

        LyraTableModel modelo = (LyraTableModel) table.getModel();
        ...
        try {
            ...
            Logger.getLogger(E01_Cargar_Lista_Tipo_Criticidad.class.getName()).log(Level.SEVERE, null, ex);
        }
