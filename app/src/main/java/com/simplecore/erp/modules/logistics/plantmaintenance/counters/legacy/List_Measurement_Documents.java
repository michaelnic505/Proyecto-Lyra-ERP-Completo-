...
public class List_Measurement_Documents extends javax.swing.JDialog {

    private TableRowSorter<DefaultTableModel> filtro;

    public List_Measurement_Documents(java.awt.Frame parent) {
...
//        if (idioma.equals(Language.SPANISH.getLangCode())) {
//
//            title.setText("Documentos de medición");
//            tabbedPanePrincipal.setTitleAt(0, "Restricciones");
//         
//            model.setColumnIdentifiers(new String[]{"Número de documento",
//                "Punto de medida",
//                "Posición",
//                "Descripción",
//                "Equipo",
...
//                "Hora de lectura",
//                "Unidad de medida",
//                "Índice de rendimiento diario (DPI)",
//                "Valor real",
//                "Valor teórico",
//                "Texto",
//                "Creado el",
//                "Creado por",});
//
//        } else if (idioma.equals(Language.ENGLISH.getLangCode())) {

            title.setText("Measurement documents");
            tabbedPanePrincipal.setTitleAt(0, "Restrictions");
           
            model.setColumnIdentifiers(new String[]{"Document",
                "Meas point",
                "Position",
                "Description",
                "Equipment",
    ...
    private void cargarDatos() {
        Measurement_Documents_List md = new Measurement_Documents_List();
        md.loadData(tableList);
    ...
    private void tableColumnsSizes() {
        ...
        tableList.getColumnModel().getColumn(2).setPreferredWidth(120);
        ...
        tableList.getColumnModel().getColumn(5).setPreferredWidth(220);

        tableList.getColumnModel().getColumn(6).setMinWidth(10);	
        tableList.getColumnModel().getColumn(6).setPreferredWidth(100);
        
        tableList.getColumnModel().getColumn(7).setMinWidth(10);	
        tableList.getColumnModel().getColumn(7).setPreferredWidth(100);
        
        tableList.getColumnModel().getColumn(8).setMinWidth(10);	
        tableList.getColumnModel().getColumn(8).setPreferredWidth(70);

        tableList.getColumnModel().getColumn(9).setMinWidth(10);	
        tableList.getColumnModel().getColumn(9).setPreferredWidth(50);

        tableList.getColumnModel().getColumn(10).setMinWidth(10);	
        tableList.getColumnModel().getColumn(10).setPreferredWidth(100);

        tableList.getColumnModel().getColumn(11).setMinWidth(10);	
        tableList.getColumnModel().getColumn(11).setPreferredWidth(110);

        tableList.getColumnModel().getColumn(12).setMinWidth(10);	
        tableList.getColumnModel().getColumn(12).setPreferredWidth(110);

        tableList.getColumnModel().getColumn(13).setMinWidth(10);	
        tableList.getColumnModel().getColumn(13).setPreferredWidth(200);

        tableList.getColumnModel().getColumn(14).setMinWidth(10);	
        tableList.getColumnModel().getColumn(14).setPreferredWidth(80);

        tableList.getColumnModel().getColumn(15).setMinWidth(10);	
        tableList.getColumnModel().getColumn(15).setPreferredWidth(80);
