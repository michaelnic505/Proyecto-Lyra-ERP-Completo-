...
public class M02_Modificacion_Materiales extends javax.swing.JPanel {

    protected static String ESTRATEGIA;    
    
    public M02_Modificacion_Materiales() {
    ...
    private void btnBuscarMaterial() {
        btnBuscarMaterial.addActionListener((ActionEvent e) -> {
          ...
          PanelLoader.loadPanel(new M02_Lista_Materiales(), mainContainerPanel);
        });
    }
    
    private void btnTipoMaterial() {
        btnTipoMaterial.addActionListener((ActionEvent e) -> {
          new M02_Lista_Tipo_Material(new javax.swing.JFrame(), true).setVisible(true);
        });
    }
        
    private void btnClaseMaterial() {
        btnClaseMaterial.addActionListener((ActionEvent e) -> {
          new M02_Lista_Clase_Material(new javax.swing.JFrame(), true).setVisible(true);
        });
    }
            
    private void btnUnidadMedida() {
        btnUnidadMedida.addActionListener((ActionEvent e) -> {
          new M02_Lista_UM(new javax.swing.JFrame(), true).setVisible(true);
        });
    }
                
    private void btnEstatusMaterial() {
        btnEstatusMaterial.addActionListener((ActionEvent e) -> {
          new M02_Lista_Estatus(new javax.swing.JFrame(), true).setVisible(true);
        });
    }
                    
    private void btnAreaMaterial() {
        btnAreaMaterial.addActionListener((ActionEvent e) -> {
          new M02_Lista_Areas(new javax.swing.JFrame(), true).setVisible(true);           
        });
    }
    ...
    private void abrirMaterial() {
        ...
        if (!(CODIGO_MATERIAL.getText().isEmpty())) {
            M02_Ver_Material verNuevo = new M02_Ver_Material();
            verNuevo.setCODIGO_MATERIAL(CODIGO_MATERIAL.getText());
            verNuevo.ver_Material();
            
            if(verNuevo.getRESULTADOS()!=null){
                
                btnTipoMaterial.setEnabled(true);
                btnClaseMaterial.setEnabled(true);
                btnEstatusMaterial.setEnabled(true);
                btnAreaMaterial.setEnabled(true);
            
            DESCRIPCION_MATERIAL.setText(verNuevo.getDESCRIPCION_MATERIAL());
            ID_TIPO_MATERIAL.setText(verNuevo.getID_TIPO_MATERIAL());
            DESCRIPCION_TIPO_MATERIAL.setText(verNuevo.getDESCRIPCION_TIPO_MATERIAL());
            ID_CLASE_MATERIAL.setText(verNuevo.getID_CLASE_MATERIAL());
            DESCRIPCION_CLASE_MATERIAL.setText(verNuevo.getDESCRIPCION_CLASE_MATERIAL());
            MARCA.setText(verNuevo.getMARCA());
            SERIE.setText(verNuevo.getSERIE());
            MODELO.setText(verNuevo.getMODELO());
            ID_ESTATUS_MATERIAL.setText(verNuevo.getID_ESTATUS_MATERIAL());
            DESCRIPCION_ESTATUS.setText(verNuevo.getDESCRIPCION_ESTATUS());
            ID_AREA_MATERIAL.setText(verNuevo.getID_AREA_MATERIAL());
            DESCRIPCION_AREA_MATERIAL.setText(verNuevo.getDESCRIPCION_AREA_MATERIAL());
            FECHA_FABRICACION.setText(verNuevo.getFECHA_FABRICACION());
            CODIGO_MATERIAL.setEditable(false);
            
            }else{
                JOptionPane.showMessageDialog(this, NOT.msg(NOT.MATERIAL_DOES_NOT_EXIST),NOT.msg(NOT.TITLE),JOptionPane.ERROR_MESSAGE);
            }
    ...
    private void modificar_Material() {
        ...
        if (!(DESCRIPCION_MATERIAL.getText().isEmpty()
            ...
            M02_Modificar_Material nuevaModificacion = new M02_Modificar_Material();
            nuevaModificacion.setCODIGO_MATERIAL(CODIGO_MATERIAL.getText());
            nuevaModificacion.setDESCRIPCION_MATERIAL(DESCRIPCION_MATERIAL.getText());
            nuevaModificacion.setID_TIPO_MATERIAL(ID_TIPO_MATERIAL.getText());
            nuevaModificacion.setDESCRIPCION_TIPO_MATERIAL(DESCRIPCION_TIPO_MATERIAL.getText());
            nuevaModificacion.setID_CLASE_MATERIAL(ID_CLASE_MATERIAL.getText());
            nuevaModificacion.setDESCRIPCION_CLASE_MATERIAL(DESCRIPCION_CLASE_MATERIAL.getText());
            nuevaModificacion.setMARCA(MARCA.getText());
            nuevaModificacion.setMODELO(MODELO.getText());
            nuevaModificacion.setSERIE(SERIE.getText());
            nuevaModificacion.setID_ESTATUS_MATERIAL(ID_ESTATUS_MATERIAL.getText());
            nuevaModificacion.setDESCRIPCION_ESTATUS(DESCRIPCION_ESTATUS.getText());
            nuevaModificacion.setID_AREA_MATERIAL(ID_AREA_MATERIAL.getText());
            nuevaModificacion.setDESCRIPCION_AREA_MATERIAL(DESCRIPCION_AREA_MATERIAL.getText());
            nuevaModificacion.setFECHA_FABRICACION(FECHA_FABRICACION.getText());
            
            nuevaModificacion.modificar_Material();
            CODIGO_MATERIAL.setEditable(false);
    ...
    private void initComponents() {
        ...
        menuBar_M02 = new javax.swing.JMenuBar();
        ...
        btnTipoMaterial = new com.simplecore.erp.gui.components.labels.JButtonHQ();
        btnClaseMaterial = new com.simplecore.erp.gui.components.labels.JButtonHQ();
        ID_CLASE_MATERIAL = new javax.swing.JTextField();
        DESCRIPCION_CLASE_MATERIAL = new javax.swing.JTextField();
        btnEstatusMaterial = new com.simplecore.erp.gui.components.labels.JButtonHQ();
        ID_ESTATUS_MATERIAL = new javax.swing.JTextField();
        DESCRIPCION_ESTATUS = new javax.swing.JTextField();
        btnAreaMaterial = new com.simplecore.erp.gui.components.labels.JButtonHQ();
        ...
        btnUnidadMedida = new com.simplecore.erp.gui.components.labels.JButtonHQ();
        ...
        menuBar_M02.add(MENU_CREACION_MATERIALES);
    ...
    protected static javax.swing.JTextField FECHA_FABRICACION;
    ...
    public static javax.swing.JMenuBar menuBar_M02;
