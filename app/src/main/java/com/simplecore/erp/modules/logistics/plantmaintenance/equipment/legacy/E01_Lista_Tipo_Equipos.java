...
import com.simplecore.erp.modules.logistics.plantmaintenance.equipment.legacy.utils.Modelo_Tipo_Equipos;
...
public class E01_Lista_Tipo_Equipos extends javax.swing.JDialog {

    TableRowSorter<DefaultTableModel> filtro;
    
    public E01_Lista_Tipo_Equipos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        cargarModeloTabla();
        cargarIconos();
    ...
    private void funcionesBotones() {
        ...
        tablaTipoEquipo.getColumnModel().getColumn(0).setCellEditor(new CellEditorLyraTable(event));
    }
    ...
    private void cargarModeloTabla(){
        Modelo_Tipo_Equipos.setLanguage(tablaTipoEquipo);
    }   

    private void cargarDatos() {

        E01_Cargar_Lista_Tipo_Equipo nuevaLista = new E01_Cargar_Lista_Tipo_Equipo();
        nuevaLista.cargarDatos(tablaTipoEquipo);
        
        Tabla_Formato.tablaNoEditable(tablaTipoEquipo, 10);        
        Tabla_Formato.editableColumn(tablaTipoEquipo, 0, 0);
        Tabla_Formato.resizeTable(tablaTipoEquipo, 10);
    ...
    private void btnMostrarBusqueda() {
        ...
        tablaTipoEquipo.setAutoCreateRowSorter(true);
        filtro = new TableRowSorter<>((DefaultTableModel) tablaTipoEquipo.getModel());
        tablaTipoEquipo.setRowSorter(filtro);
    }
    ...
    private void seleccionTipoEquipo() {
        ...
        int fila = tablaTipoEquipo.getSelectedRow();
        if (fila > -1) {

            String ID = tablaTipoEquipo.getValueAt(fila, 1).toString();
            String DESCRIPCION = tablaTipoEquipo.getValueAt(fila, 2).toString();

            E01_Crear_Equipo_Panel.idTipoEquipoTB.setText(ID);
            E01_Crear_Equipo_Panel.descripcionTipoEquipoTB.setText(DESCRIPCION);
    ...
    private void initComponents() {
        ...
        tablaTipoEquipo = new com.simplecore.erp.gui.components.tables.lastversion.LyraTable();
        ...
        tablaTipoEquipo.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(tablaTipoEquipo);
    ...
    private com.simplecore.erp.gui.components.tables.lastversion.LyraTable tablaTipoEquipo;
