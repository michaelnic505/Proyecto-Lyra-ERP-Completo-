...
public class ProceduresList extends javax.swing.JDialog {
    
    private LanguageManager languageManager;
    private JButton button;
    private TableRowSorter<DynamicTableModel> filter;
    
    public ProceduresList(Frame parent, JButton button) {
    ...
    private void setLocations(JButton button) {
        ...
        setLocation(buttonLocation.x + 40, buttonLocation.y - 120);
    }
    ...
    private void selectButton() {
        selectButton.addActionListener(e -> {
            ...
            if (row != -1) {
                ...
                Object codeG = tableList.getModel().getValueAt(row, 0);
                Object descG = tableList.getModel().getValueAt(row, 1);
                if (tf != null) {
        ...
        tableList.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                if (e.getClickCount() == 2 && tableList.getSelectedRow() != -1) {
                    ...
                    Object codeG = tableList.getModel().getValueAt(tableList.getSelectedRow(), 0);
                    Object descG = tableList.getModel().getValueAt(tableList.getSelectedRow(), 1);
    ...
    private void applyTranslations(LanguageManager lm) {
        ...
        String title = LyraWorkspace.getTranslator().getTranslation("ProceduresListWindow.title");
    ...
    private String[] getTableColumnsName(){
        ...
        String PROCEDUREKEY = LyraWorkspace.getTableTranslator().getTranslation("column.PROCEDUREKEY");
        String SHORDESCRIPTION = LyraWorkspace.getTableTranslator().getTranslation("column.SHORDESCRIPTION");
    
        return new String[]{PROCEDUREKEY,SHORDESCRIPTION};
    }
    private void setTableModel() {

        String[] columns = getTableColumnsName();
        
        MaintProcedures query = new MaintProcedures();
        List<List<Object>> matrix = query.getMaintStrategies();
        ...
        tableList.getColumnModel().getColumn(1).setPreferredWidth(300); // StratDesc
