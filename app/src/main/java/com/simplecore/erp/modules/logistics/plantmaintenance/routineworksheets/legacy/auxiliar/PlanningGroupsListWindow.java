...
public class PlanningGroupsListWindow extends javax.swing.JDialog {
    
    private LanguageManager languageManager;
    private JButton button;
    private TableRowSorter<DynamicTableModel> filter;
    
    public PlanningGroupsListWindow(Frame parent, JButton button, LanguageManager languageManager) {
...
// Overloaded method for a JTextField and a JLabel
    ...
    private void applyTranslations(LanguageManager lm) {
        ...
        String title = LyraWorkspace.getTranslator().getTranslation("PlanningGroupsListWindow.title");
    ...
    private String[] getTableColumnsName() {
        ...
        String planGroupCode = LyraWorkspace.getTableTranslator().getTranslation("column.planGroupCode");
        String planningGroupName = LyraWorkspace.getTableTranslator().getTranslation("column.planningGroupName");

        return new String[]{planGroupCode, planningGroupName};
    }
    ...
    private void setTableModel() {
        ...
        PlanningGroups pG = new PlanningGroups();
        List<List<Object>> matrix = pG.getGroups(true);
