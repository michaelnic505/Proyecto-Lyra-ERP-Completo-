...
public class M09_Lista_Materiales_Inventario extends javax.swing.JPanel {
    
    String VistaSQL;
    private TableRowSorter<DefaultTableModel> filtro;
    
    public M09_Lista_Materiales_Inventario() {
        initComponents(); 
        addEvents();
        cargarTabla();
    }
    ...
    private void cargarTabla() {
        ...
        M09_Cargar_Lista_Inventario nuevaLista = new M09_Cargar_Lista_Inventario();
    ...
    private void filtrarMARCA_MATERIAL() {
        MARCA_MATERIAL.addKeyListener(new KeyAdapter(){
            @Override
            public void keyReleased(KeyEvent e) {
               filtro.setRowFilter(RowFilter.regexFilter(MARCA_MATERIAL.getText(), 9));
            }            
        });
    ...
    private void seleccionarMaterial(){
        ...
        if (tabla_Materiales.getSelectedRow() > -1) {
            ...
            String CODIGO_ALMA = tabla_Materiales.getValueAt(tabla_Materiales.getSelectedRow(), 3).toString();
            String DESCRIPCION_ALMA = tabla_Materiales.getValueAt(tabla_Materiales.getSelectedRow(), 4).toString();
            String UM = tabla_Materiales.getValueAt(tabla_Materiales.getSelectedRow(), 5).toString();
            String DESCRIPCION_UM = tabla_Materiales.getValueAt(tabla_Materiales.getSelectedRow(), 6).toString();
            ...
            String MARCA = tabla_Materiales.getValueAt(tabla_Materiales.getSelectedRow(), 9).toString();
            String PRECIO = tabla_Materiales.getValueAt(tabla_Materiales.getSelectedRow(), 11).toString();
            ...
            M09_Movimiento_de_Materiales.CODIGO_ALMACEN.setText(CODIGO_ALMA);
            M09_Movimiento_de_Materiales.DESCRIPCION_ALMACEN.setText(DESCRIPCION_ALMA);
            M09_Movimiento_de_Materiales.PRECIO_UNITARIO.setText(PRECIO);
    ...
    private void initComponents() {
        ...
        LABELTITULO.setText("M09 - Lista de Inventario de Materiales");
        ...
        titlePanelLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, titlePanelLayout.createSequentialGroup()
                .addGap(10, 10, 10)
                .addComponent(LABELTITULO, javax.swing.GroupLayout.PREFERRED_SIZE, 504, javax.swing.GroupLayout.PREFERRED_SIZE)
