...
public class M05_Cargar_Lista_Estatus_Almacen {
    ...
    public void cargar_Lista_Estatus_Almacen() {
        ...
        try {
            ...
            Logger.getLogger(M05_Cargar_Lista_Estatus_Almacen.class.getName()).log(Level.SEVERE, null, ex);
        }
