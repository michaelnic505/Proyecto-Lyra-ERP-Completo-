...
public class Verificar_Registro_Operacion_SQL {

    private static boolean isRegistered = false;

    public static boolean isOperationRegistered(String numeroRegistro) {
        ...
        try {
            ...
            Logger.getLogger(Verificar_Registro_Operacion_SQL.class.getName()).log(Level.SEVERE, null, ex);
        }
