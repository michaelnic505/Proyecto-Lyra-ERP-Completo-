...
public class M01_Cargar_Lista_Area_Material {
    ...
    public void cargar_Lista_Area_Material() {
        ...
        try {
            ...
            Logger.getLogger(M01_Cargar_Lista_Area_Material.class.getName()).log(Level.SEVERE, null, ex);
        }
