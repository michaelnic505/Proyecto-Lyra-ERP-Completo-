...
public class M02_Lista_Estatus extends javax.swing.JDialog {
    
    public M02_Lista_Estatus(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        cargarModeloTabla();       
    ...
    private void cargarModeloTabla(){
        M02_Modelo_Lista_Estatus.set(tablaEstatusMaterial);
    }   


    private void cargar_Estatus_Material() {
        
        M02_Cargar_Lista_Estatus_Material nuevaLista = new M02_Cargar_Lista_Estatus_Material();   
    ...
    private void seleccionEstatusMaterial(){
        ...
        int fila = tablaEstatusMaterial.getSelectedRow();
            if(fila>-1){
              ...
              M02_Modificacion_Materiales.ID_ESTATUS_MATERIAL.setText(ID_TIPO_MATERIAL);
              M02_Modificacion_Materiales.DESCRIPCION_ESTATUS.setText(DESCRIPCION_TIPO_MAT);
