...
public class M04_Lista_Estatus extends javax.swing.JDialog {

    String VistaSQL;
    
    public M04_Lista_Estatus(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();        
        cargarDatos();
        addEvents();
    ...
    private void cargarDatos() {
        ...
        M04_Cargar_Lista_Estatus_Almacen nuevaLista = new M04_Cargar_Lista_Estatus_Almacen();    
    ...
    private void seleccionEstatus(){
        ...
        int fila = tablaEstatusAlmacen.getSelectedRow();
            if(fila>-1){
              ...
              M04_Creacion_Almacen.ID_ESTATUS_ALMACEN.setText(ID_ESTATUS_ALMACEN);
              M04_Creacion_Almacen.DESCRIPCION_ESTATUS.setText(DESCRIPCION_ESTATUS);
