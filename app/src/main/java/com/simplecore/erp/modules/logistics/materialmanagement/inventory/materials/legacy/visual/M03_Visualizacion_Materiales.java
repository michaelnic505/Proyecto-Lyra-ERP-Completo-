...
public class M03_Visualizacion_Materiales extends javax.swing.JPanel {

    protected static String ESTRATEGIA;    
    
    public M03_Visualizacion_Materiales() {
        initComponents(); 
        addEvents();
    }
    ...
    private void btnBuscarMaterial() {
        btnBuscarMaterial.addActionListener((ActionEvent e) -> {          
          PanelLoader.loadPanel(new M03_Lista_Materiales(), mainContainerPanel);
        });
    }
    ...
    private void abrirMaterial() {
        ...
        if (!(CODIGO_MATERIAL.getText().isEmpty())) {
            M03_Ver_Material verNuevo = new M03_Ver_Material();
    ...
    private void initComponents() {
        ...
        menuBar_M03 = new javax.swing.JMenuBar();
        ...
        menuBar_M03.add(MENU_CREACION_MATERIALES);
    ...
    public static javax.swing.JMenuBar menuBar_M03;
