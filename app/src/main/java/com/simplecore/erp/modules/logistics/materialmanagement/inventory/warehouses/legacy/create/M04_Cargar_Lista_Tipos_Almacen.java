...
public class M04_Cargar_Lista_Tipos_Almacen {
    ...
    public void cargar_Lista_Tipo_Almacen() {
        ...
        try {
            ...
            Logger.getLogger(M04_Cargar_Lista_Tipos_Almacen.class.getName()).log(Level.SEVERE, null, ex);
        }
