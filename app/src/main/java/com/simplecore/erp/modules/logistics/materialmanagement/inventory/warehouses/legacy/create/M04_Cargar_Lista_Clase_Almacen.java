...
public class M04_Cargar_Lista_Clase_Almacen {
    ...
    public void cargar_Lista_Clase_Almacen() {
        ...
        try {
            ...
            Logger.getLogger(M04_Cargar_Lista_Clase_Almacen.class.getName()).log(Level.SEVERE, null, ex);
        }
