...
public class M02_Lista_Materiales extends javax.swing.JPanel {
    
    String VistaSQL;
    private TableRowSorter<DefaultTableModel> filtro;
    
    public M02_Lista_Materiales() {
        initComponents(); 
        addEvents();
        cargarTabla();
    }
    ...
    private void seleccionMaterial() {
        ...
        if (tabla_Materiales.getSelectedRow() > -1) {
            ...
            M02_Modificacion_Materiales.CODIGO_MATERIAL.setText(CODIGO_MAT);
            M02_Modificacion_Materiales.DESCRIPCION_MATERIAL.setText(DESCRIPCION_MAT);
            M02_Modificacion_Materiales.ID_TIPO_MATERIAL.setText(ID_TIPO_MATERIAL);
            M02_Modificacion_Materiales.DESCRIPCION_TIPO_MATERIAL.setText(DESCRIPCION_TIPO_MATERIAL);
            M02_Modificacion_Materiales.ID_CLASE_MATERIAL.setText(ID_CLASE_MATERIAL);
            M02_Modificacion_Materiales.DESCRIPCION_CLASE_MATERIAL.setText(DESCRIPCION_CLASE_MATERIAL);
            M02_Modificacion_Materiales.MARCA.setText(MARCA);
            M02_Modificacion_Materiales.MODELO.setText(MODELO);
            M02_Modificacion_Materiales.SERIE.setText(SERIE);
            M02_Modificacion_Materiales.ID_ESTATUS_MATERIAL.setText(ID_ESTATUS_MATERIAL);
            M02_Modificacion_Materiales.DESCRIPCION_ESTATUS.setText(DESCRIPCION_ESTATUS);
            M02_Modificacion_Materiales.ID_AREA_MATERIAL.setText(ID_AREA_MATERIAL);
            M02_Modificacion_Materiales.DESCRIPCION_AREA_MATERIAL.setText(DESCRIPCION_AREA_MATERIAL);
            M02_Modificacion_Materiales.FECHA_FABRICACION.setText(FECHA_FABRICACION);
