...
public class PM3_Visualizacion_Punto_Medida extends javax.swing.JPanel {
    
    private CharacteristicService characteristicService;
    
    public PM3_Visualizacion_Punto_Medida() {
        initComponents();
        startServices();
        disableComponent();
        addEvents();
    ...
    private void addEvents(){
        ...
        sbGrupoAutorizacion.getButton().setEnabled(false);
    ...
    private void initComponents() {
        ...
        inactiveRButton.setEnabled(false);
