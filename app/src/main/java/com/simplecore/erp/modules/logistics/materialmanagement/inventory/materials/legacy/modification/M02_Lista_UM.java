...
public class M02_Lista_UM extends javax.swing.JDialog {
    
    public M02_Lista_UM(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        cargarModeloTabla();       
        cargarDatos();
    ...
    private void cargarModeloTabla(){
        M02_Modelo_Tabla_UM.modeloTablaUnidadesMedida(tablaUnidadMedida);
    }   
    ...
    private void cargarDatos() {
        ...
        M02_Cargar_Lista_UM nuevaLista = new M02_Cargar_Lista_UM();     
    ...
    private void seleccionUnidadMedida() {
        ...
        int fila = tablaUnidadMedida.getSelectedRow();
            if (fila > -1) {
                ...
                M02_Modificacion_Materiales.ID_UM.setText(UM);
                M02_Modificacion_Materiales.DESCRIPCION_UM.setText(DESCRIPCION_UM);
