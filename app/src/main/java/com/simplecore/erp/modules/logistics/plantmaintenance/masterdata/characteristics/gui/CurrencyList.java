...
import com.simplecore.erp.modules.logistics.plantmaintenance.counters.legacy.MeasurePointTypes;
...
import com.simplecore.erp.modules.logistics.plantmaintenance.equipment.legacy.utils.CargarListadoDivisas;

public class CurrencyList extends javax.swing.JDialog {
    
    
    private TableRowSorter<DefaultTableModel> filtro;

    
    public CurrencyList(java.awt.Frame parent) {
    ...
    private void modeloTabla() {
        ...
        tableList.setModel(cargarListadoDivisas.getModel());
    ...
    public void setTitles(String titl) {
        title.setText(titl);
    }
    public void setTabbedTitle(String titl) {
        tabbedPanePrincipal.setTitleAt(0, titl);
    }
    ...
    private void edicionTabla() {
       ...
       tableList.getColumnModel().getColumn(1).setMinWidth(100);
       tableList.getColumnModel().getColumn(1).setPreferredWidth(200);
       
       tableList.getColumnModel().getColumn(2).setMinWidth(10);
       tableList.getColumnModel().getColumn(2).setPreferredWidth(90);
    ...
    private void botonOk() {
        btnSeleccionar.addActionListener((ActionEvent e) -> {
            ...
            if (tableList.getSelectedRow() > -1) {
                ...
                if(cod!=null){
                    cod.setText(tableList.getValueAt(tableList.getSelectedRow(), 2).toString());
                }
                if(texto!=null){
