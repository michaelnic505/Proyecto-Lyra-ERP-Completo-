...
public class Lista_Componentes extends javax.swing.JDialog {

    TableRowSorter<DefaultTableModel> filtro;

    public Lista_Componentes(java.awt.Frame parent, boolean modal) {
    ...
    private void funcionesBotones() {
        ...
        tablaComponentes.getColumnModel().getColumn(0).setCellEditor(new CellEditorLyraTable(event));
    }
    ...
    private void cargarDatos() {
        ...
        Lista_Componentes_Model.set(tablaComponentes);
        
        Lista_Componentes_SQL data = new Lista_Componentes_SQL();
        data.setTable(tablaComponentes);
        data.cargarDatos();
        
        Tabla_Formato.tablaNoEditable(tablaComponentes, 10);        
        Tabla_Formato.editableColumn(tablaComponentes, 0, 0);
        Tabla_Formato.resizeTable(tablaComponentes, 10);
    ...
    private void btnMostrarBusqueda() {
        ...
        tablaComponentes.setAutoCreateRowSorter(true);
        filtro = new TableRowSorter<>((DefaultTableModel) tablaComponentes.getModel());
        tablaComponentes.setRowSorter(filtro);
    }
    ...
    private void seleccionTipoEquipo() {
        ...
        if (fila > -1) {
            ...
            String codigoSt = tablaComponentes.getValueAt(fila, 1).toString();
            String descripcionSt = tablaComponentes.getValueAt(fila, 2).toString();
    ...
    private void initComponents() {
        ...
        tablaComponentes = new com.simplecore.erp.gui.components.tables.lastversion.LyraTable();
    ...
    private com.simplecore.erp.gui.components.tables.lastversion.LyraTable tablaComponentes;
