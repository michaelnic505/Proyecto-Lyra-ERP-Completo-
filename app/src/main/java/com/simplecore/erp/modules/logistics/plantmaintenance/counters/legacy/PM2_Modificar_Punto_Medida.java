...
public class PM2_Modificar_Punto_Medida extends javax.swing.JPanel {
    
    
    public PM2_Modificar_Punto_Medida() {
        ...
        cmdProceder.addActionListener((e) -> {
            ...
            if (!sbMeasurePoint.getTextBox().getText().isEmpty()) {
                ...
                if (IsMeasPointCreated.measPointExists(meas)) {
                    ...
                    PM2_Modificacion_Punto_Medida mpm = new PM2_Modificacion_Punto_Medida();
