...
public class MaintProceduresEditor extends DefaultCellEditor {

    private MaintenanceProceduresList popupDialog;
    private final AWTEventListener awtEventListener;

    public MaintProceduresEditor(JTextField textField) {
        super(textField);
    ...
    public Component getTableCellEditorComponent(JTable table, Object value, boolean isSelected, int row, int column) {
        ...
        if (popupDialog == null) {
            popupDialog = new MaintenanceProceduresList((Frame) null, false);
        }
