...
public class Lista_Sintomas extends javax.swing.JDialog {

    TableRowSorter<DefaultTableModel> filtro;

    public Lista_Sintomas(java.awt.Frame parent, boolean modal) {
    ...
    private void funcionesBotones() {
        ...
        tablaSintomas.getColumnModel().getColumn(0).setCellEditor(new CellEditorLyraTable(event));
    }
    ...
    private void cargarDatos() {
        ...
        Lista_Sintomas_Model.set(tablaSintomas);
        
        Lista_Sintomas_SQL data = new Lista_Sintomas_SQL();
        data.setTable(tablaSintomas);
        data.cargarDatos();
        
        Tabla_Formato.tablaNoEditable(tablaSintomas, 10);        
        Tabla_Formato.editableColumn(tablaSintomas, 0, 0);
        Tabla_Formato.resizeTable(tablaSintomas, 5);
    ...
    private void btnMostrarBusqueda() {
        ...
        tablaSintomas.setAutoCreateRowSorter(true);
        filtro = new TableRowSorter<>((DefaultTableModel) tablaSintomas.getModel());
        tablaSintomas.setRowSorter(filtro);
    }
    ...
    private void seleccionTipoEquipo() {
        ...
        if (fila > -1) {
            ...
            String codigoSt = tablaSintomas.getValueAt(fila, 1).toString();
            String descripcionSt = tablaSintomas.getValueAt(fila, 2).toString();
    ...
    private void initComponents() {
        ...
        tablaSintomas = new com.simplecore.erp.gui.components.tables.lastversion.LyraTable();
    ...
    private com.simplecore.erp.gui.components.tables.lastversion.LyraTable tablaSintomas;
