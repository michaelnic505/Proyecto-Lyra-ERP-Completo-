...
public class M01_Cargar_Lista_Clase_Material {
    ...
    public void cargar_Lista_Clase_Material() {
        ...
        try {
            ...
            Logger.getLogger(M01_Cargar_Lista_Clase_Material.class.getName()).log(Level.SEVERE, null, ex);
        }
