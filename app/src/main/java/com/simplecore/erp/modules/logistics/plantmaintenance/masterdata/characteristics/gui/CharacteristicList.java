...
public class CharacteristicList extends javax.swing.JDialog {
    
    private TableRowSorter<DefaultTableModel> filtro;
    private CharacteristicService characteristicService;
    
    public CharacteristicList(java.awt.Frame parent, CharacteristicService characteristicService) {
    ...
    private void modeloTabla() {
        ...
        model.setColumnIdentifiers(new String[]{"Characteristic", "Valid from", "Status", "Description"});
    ...
    private void cargarDatos() {
        ...
        characteristicService.loadDataInTable((DefaultTableModel) tableList.getModel());        
    ...
    private void edicionTabla() {
        ...
        tableList.getColumnModel().getColumn(1).setMinWidth(90);
        tableList.getColumnModel().getColumn(1).setPreferredWidth(100);

        tableList.getColumnModel().getColumn(2).setMinWidth(90);
        tableList.getColumnModel().getColumn(2).setPreferredWidth(100);

        tableList.getColumnModel().getColumn(3).setMinWidth(200);
