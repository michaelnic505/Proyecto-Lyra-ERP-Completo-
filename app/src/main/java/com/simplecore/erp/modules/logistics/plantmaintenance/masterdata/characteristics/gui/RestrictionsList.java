...
public class RestrictionsList extends javax.swing.JDialog {
    
    private TableRowSorter<DefaultTableModel> filtro;

    
    public RestrictionsList(java.awt.Frame parent) {
    ...
    private void modeloTabla() {
        ...
        title.setText("Type of classes");
        tabbedPanePrincipal.setTitleAt(0, "Parameters");
        model.setColumnIdentifiers(new String[]{"Type of class", "Description"});
    ...
    private void cargarDatos() {
        ...
        String[] classTypeList = Class_Type_List.getClassTypeCodesList();

        for (int i = 0; i < classTypeList.length; i++) {

            model.addRow(new String[]{classTypeList[i],Class_Type_List.getClassTypeDescriptionByIndex(i)});
        }
