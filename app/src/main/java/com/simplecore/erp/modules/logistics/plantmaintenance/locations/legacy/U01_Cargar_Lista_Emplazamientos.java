 ...
 * @author user
 */
public class U01_Cargar_Lista_Emplazamientos {
    ...
    public void cargarEmplazamientos() {
        ...
        try {
            ...
            Logger.getLogger(U01_Cargar_Lista_Emplazamientos.class.getName()).log(Level.SEVERE, null, ex);
        }
