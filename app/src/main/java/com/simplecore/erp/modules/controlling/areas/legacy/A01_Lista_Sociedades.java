...
public class A01_Lista_Sociedades extends javax.swing.JDialog {

    TableRowSorter<DefaultTableModel> filtro;
    
    public A01_Lista_Sociedades(java.awt.Frame parent, boolean modal) {
    ...
    private void cargarDatos() {        
        ...
        Modelo_Lista_Sociedades.setLanguage(tablaSociedades);
        
        A01_Cargar_Lista_Sociedad nuevaLista = new A01_Cargar_Lista_Sociedad();
        nuevaLista.setTable(tablaSociedades);
        nuevaLista.cargarDatos();
        
        Tabla_Formato.tablaNoEditable(tablaSociedades, 10);
    ...
    private void ConfigurarFiltroEnTabla() {
        ...
        tablaSociedades.setAutoCreateRowSorter(true);
        filtro = new TableRowSorter<>((DefaultTableModel) tablaSociedades.getModel());
        tablaSociedades.setRowSorter(filtro);
    }
    ...
    public void setCodigoTextfield(JTextField codigoTex) {
        this.codigoTex = codigoTex;

    }

    private JTextField descripcionSociedad;

    public void setDescripcionTextfield(JTextField descripcionSociedad) {
    ...
    private void seleccionarAreaSuperior(){
         ...
         if (tablaSociedades.getSelectedRow() > -1) {

            String idSociedad = tablaSociedades.getValueAt(tablaSociedades.getSelectedRow(), 0).toString();
            String desSociedad = tablaSociedades.getValueAt(tablaSociedades.getSelectedRow(), 1).toString();

            
            if(codigoTex!=null){
                codigoTex.setText(idSociedad);
            }

            if(descripcionSociedad!=null){
                descripcionSociedad.setText(desSociedad);
            }
    ...
    private void initComponents() {
        ...
        tablaSociedades = new com.simplecore.erp.gui.components.tables.lastversion.SimpleLyraTable();
        ...
        tablaSociedades.setAutoCreateRowSorter(true);
        tablaSociedades.setBackground(new java.awt.Color(202, 219, 236));
    ...
    private com.simplecore.erp.gui.components.tables.lastversion.SimpleLyraTable tablaSociedades;
