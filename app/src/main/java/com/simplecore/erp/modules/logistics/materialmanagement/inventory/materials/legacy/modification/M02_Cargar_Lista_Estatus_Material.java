...
public class M02_Cargar_Lista_Estatus_Material {
    ...
    public void cargar_Lista_Tipo_Material() {
        ...
        try {
            ...
            Logger.getLogger(M02_Cargar_Lista_Estatus_Material.class.getName()).log(Level.SEVERE, null, ex);
        }
