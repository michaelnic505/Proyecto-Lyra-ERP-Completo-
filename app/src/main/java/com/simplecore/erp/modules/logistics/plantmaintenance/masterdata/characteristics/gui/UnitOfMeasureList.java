...
public class UnitOfMeasureList extends javax.swing.JDialog {
    
    private TableRowSorter<DefaultTableModel> filtro;
    
    public UnitOfMeasureList(java.awt.Frame parent) {
    ...
    private void modeloTabla() {
        ...
        title.setText("Units of Measurement");
        tabbedPanePrincipal.setTitleAt(0, "Restrictions");
        model.setColumnIdentifiers(new String[]{"Symbol", "Name", "Conversion Factor"});
    ...
    private void cargarDatos() {
        ...
        String[] simbolos = units.getSymbols();

        for (int i = 0; i < simbolos.length; i++) {

            model.addRow(new String[]{simbolos[i], units.getDescription(i), units.getConversionFactor(i)});
        }
