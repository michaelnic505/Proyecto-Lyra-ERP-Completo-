...
public class M02_Lista_Areas extends javax.swing.JDialog {
    
    public M02_Lista_Areas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        cargarModeloTabla();
        cargarDatos();
    ...
    private void cargarModeloTabla(){
        M02_Modelo_Lista_Areas.set(tablaAreaMaterial);
    }   


    private void cargarDatos() {
        
        M02_Cargar_Lista_Area_Material nuevaLista = new M02_Cargar_Lista_Area_Material();      
    ...
    private void seleccionAreaMaterial(){
        ...
        int fila = tablaAreaMaterial.getSelectedRow();
            if(fila>-1){
              ...
              M02_Modificacion_Materiales.ID_AREA_MATERIAL.setText(ID_TIPO_MATERIAL);
              M02_Modificacion_Materiales.DESCRIPCION_AREA_MATERIAL.setText(DESCRIPCION_TIPO_MAT);
