...
public class M11_Lista_Materiales_Movimientos extends javax.swing.JPanel {
    
    String VistaSQL;
    private TableRowSorter<DefaultTableModel> filtro;
    
    public M11_Lista_Materiales_Movimientos() {
        initComponents(); 
        addEvents();
        cargarTabla();
    }
    ...
    private void cargarTabla() {
        ...
        M11_Cargar_Lista_Movimientos nuevaLista = new M11_Cargar_Lista_Movimientos();
    ...
    private void initComponents() {
        ...
        menuBar_M11 = new javax.swing.JMenuBar();
        ...
        menuBar_M11.add(MENU_LISTA_MATERIALES);
        ...
        menuBar_M11.add(MENU_DATOS);

        MENU_AYUDA.setText("Ayuda");
        menuBar_M11.add(MENU_AYUDA);
    ...
    public static javax.swing.JMenuBar menuBar_M11;
