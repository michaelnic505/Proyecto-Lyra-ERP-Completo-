...
public class U01_Lista_Emplazamientos extends javax.swing.JDialog {

    TableRowSorter<DefaultTableModel> filtro;
    
    public U01_Lista_Emplazamientos(java.awt.Frame parent, boolean modal) {
    ...
    private void funcionesBotones() {
        ...
        tablaEmplazamientos.getColumnModel().getColumn(1).setCellEditor(new CellEditorLyraTable(event));
    }
    ...
    private void cargarDatos() {        
        ...
        U01_Cargar_Lista_Emplazamientos emp = new U01_Cargar_Lista_Emplazamientos();
        emp.setTable(tablaEmplazamientos);
        emp.cargarEmplazamientos();        
        
        Tabla_Formato.tablaNoEditable(tablaEmplazamientos, 15);
    ...
    private void seleccionarAreaSuperior(){
         ...
         if (tablaEmplazamientos.getSelectedRow() > -1) {
            ...
            String area = tablaEmplazamientos.getValueAt(tablaEmplazamientos.getSelectedRow(), 0).toString();
            String descripcionArea = tablaEmplazamientos.getValueAt(tablaEmplazamientos.getSelectedRow(), 1).toString();
           

            U01_Crear_Ubicaciones.idEmplazamiento.setText(area);
            U01_Crear_Ubicaciones.descripcionEmplazamiento.setText(descripcionArea);
