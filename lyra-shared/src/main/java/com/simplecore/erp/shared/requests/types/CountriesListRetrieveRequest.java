 ...
 * 
 */
public class CountriesListRetrieveRequest extends BaseRequest {

    public CountriesListRetrieveRequest(String sessionId, int userId) {
        super(sessionId, userId);
    }

    @Override
    public RequestType getRequestType() {
       return RequestType.COUNTRIES_LIST;
    }
