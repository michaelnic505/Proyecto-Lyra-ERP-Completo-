 ...
 * 
 */
public class ChartOfAccountsListRetrieveResponse extends BaseResponse {

    private Object[][] dataSource;
    
    public ChartOfAccountsListRetrieveResponse(String sessionId, ResultType resultType, List<Object[]>dataSource) {
    ...
    public ResponseType getResponseType() {
        return ResponseType.FI_CHART_OF_ACCOUNTS_LIST;
    }
}
