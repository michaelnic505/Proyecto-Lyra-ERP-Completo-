 ...
 * 
 */
public class CurrenciesListRetrieveRequest extends BaseRequest {

    public CurrenciesListRetrieveRequest(String sessionId, int userId) {
        super(sessionId, userId);
    }

    @Override
    public RequestType getRequestType() {
        return RequestType.CURRENCIES_LIST;
    }
