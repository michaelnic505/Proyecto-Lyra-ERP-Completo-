 ...
 * 
 */
public class CurrenciesListRetrieveResponse extends BaseResponse{

    private Object[][]dataSource;

    public CurrenciesListRetrieveResponse(String sessionId,ResultType resultType,List<Object[]>dataSource) {
    ...
    public ResponseType getResponseType() {
        return ResponseType.CURRENCIES_LIST;
    }
