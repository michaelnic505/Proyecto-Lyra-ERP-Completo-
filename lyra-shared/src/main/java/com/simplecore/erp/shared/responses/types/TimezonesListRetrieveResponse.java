 ...
 * 
 */
public class TimezonesListRetrieveResponse extends BaseResponse {

    private final Object[][]dataSource;
    
    public TimezonesListRetrieveResponse(String sessionId, ResultType resultType, List<Object[]> dataSource) {
    ...
    public ResponseType getResponseType() {
        return ResponseType.TIMEZONES_LIST;
    }
