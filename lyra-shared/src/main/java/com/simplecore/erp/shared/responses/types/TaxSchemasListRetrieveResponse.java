 ...
 * 
 */
public class TaxSchemasListRetrieveResponse extends BaseResponse {

    private Object[][]dataSource;
    
    public TaxSchemasListRetrieveResponse(String sessionId,ResultType resultType,List<Object>dataSource) {
    ...
    public ResponseType getResponseType() {
        return ResponseType.FI_TAX_SCHEMAS_LIST;
    }
