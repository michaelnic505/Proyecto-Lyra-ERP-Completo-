 ...
 * 
 */
public class CountriesListRetrieveResponse extends BaseResponse{

    private Object[][]dataSource; 
    
    public CountriesListRetrieveResponse(String sessionId,ResultType resultType,List<Object[]>dataSource){
    ...
    public ResponseType getResponseType() {
       return ResponseType.COUNTRIES_LIST;
    }
