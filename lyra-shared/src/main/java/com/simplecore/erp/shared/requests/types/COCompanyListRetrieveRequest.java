 ...
 * 
 */
public class COCompanyListRetrieveRequest extends BaseRequest{

    public COCompanyListRetrieveRequest(String sessionId, int userId) {
        super(sessionId, userId);
    }

    @Override
    public RequestType getRequestType() {
        return RequestType.CO_COMPANY_LIST;
    }
}
