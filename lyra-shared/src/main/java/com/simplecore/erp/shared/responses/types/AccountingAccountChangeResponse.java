 ...
 * 
 */
public class AccountingAccountChangeResponse extends BaseResponse {

    public AccountingAccountChangeResponse(String sessionId,ResultType resultType) {
        super(sessionId,resultType);
    }

    @Override
    public ResponseType getResponseType() {
        return ResponseType.FI_ACCOUNTING_ACCOUNT_CHANGE;
    }
}
