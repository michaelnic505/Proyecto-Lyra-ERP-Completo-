 ...
 * 
 */
public class FICompanyExistenceCheckResponse extends BaseResponse {

    public FICompanyExistenceCheckResponse(String sessionId, ResultType resultType) {
        super(sessionId, resultType);
    }

    @Override
    public ResponseType getResponseType() {
        return ResponseType.FI_COMPANY_EXISTS;
    }
