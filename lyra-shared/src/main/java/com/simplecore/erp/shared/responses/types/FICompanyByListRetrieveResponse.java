 ...
 * 
 */
public class FICompanyByListRetrieveResponse extends BaseResponse{

    private final Object[][]dataSource;
    public FICompanyByListRetrieveResponse(String sessionId, ResultType resultType,List<Object[]>dataSource) {
    ...
    public ResponseType getResponseType() {
        return ResponseType.FI_COMPANY_BY_LIST_RETRIEVE;
    }
