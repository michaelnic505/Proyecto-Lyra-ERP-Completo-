 ...
 * 
 */
public class FICompanyModifyResponse extends BaseResponse{

    public FICompanyModifyResponse(String sessionId, ResultType resultType) {
        super(sessionId, resultType);
    }

    @Override
    public ResponseType getResponseType() {
        return ResponseType.FI_COMPANY_MODIFY;
    }
}
